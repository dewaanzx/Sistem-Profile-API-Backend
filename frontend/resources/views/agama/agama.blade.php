                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col">
                                            <button class="btn btn-info btn-block" data-toggle="modal" data-target="#edit{{ $agama['id'] }}">Edit</button>
                                        </div>
                                        <div class="col">
                                            <form action="/agama36/{{ $agama['id'] }}" method="post">
                                                @csrf
                                                @method('delete')
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="/agama36" method="post">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Nama agama</label>
                        <input type="text" class="form-control" name="nama_agama" value="{{ old('nama_agama') }}" required>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="/agama36/{{ $agama['id'] }}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Nama agama</label>
                        <input type="text" class="form-control" name="nama_agama" value="{{ $agama['nama_agama'] }}" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-end">
                    <button type="button" class="btn btn-warning" data-dismiss="modal">Close</button>
